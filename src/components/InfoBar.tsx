            ...
            <div className="container">
                <div className="info-bar-content">
                    <div className="info-bar-left">
                        <a href={`tel:${contact.phone}`} className="info-link">
                    ...
                    <div className="info-bar-center">
                        <p className="promo-text">{message}</p>
                    </div>
                    ...
                    <div className="info-bar-right">
                        ...
                        <a href={social.twitter} target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Twitter">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
