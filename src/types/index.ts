export type { AboutContent, AboutPageHeader, AboutSection } from './about';
...
export type { FAQData, FAQItem } from './faqs';
export type {
    Course,
    CoursesContent,
    CoursesSection,
...
export type {
    ...
    GallerySection,
    GalleryImage,
    TestimonialsSection as TrainingTestimonialsSection,
    Testimonial as TrainingTestimonial,
    OtherServicesSection,
    OtherServiceItem,
    WhyLaptianBlock,
    TrainingHighlightBlock,
